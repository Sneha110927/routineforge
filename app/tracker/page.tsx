      ...
      <div className="sticky top-0 z-20 border-b border-slate-100 bg-white/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button className="grid h-9 w-9 place-items-center rounded-xl hover:bg-slate-50" aria-label="Settings">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-10 space-y-6">
          <InputCard
            ...
            subtitle="Track your weight to monitor progress over time"
          >
            <input
              value={weightKg}
          ...
          <InputCard
            ...
            subtitle="How well did you stick to your meal plan today?"
          >
            <div className="mt-2">
              <input
                type="range"
          ...
          <InputCard
            ...
            subtitle="How many glasses of water did you drink? (Target: 8)"
          >
            <input
              value={waterGlasses}
          ...
          <InputCard
            title="Sleep Hours"
            subtitle="How many hours did you sleep last night? (Target: 7-8)"
          >
            <input
              value={sleepHours}
          ...
          <InputCard
            ...
            subtitle="Any additional thoughts or observations?"
          >
            <textarea
              value={notes}

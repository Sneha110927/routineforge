      ...
      >
        <div className="p-5">
          ...
          <div className="mt-4 flex items-center gap-2 text-xs font-semibold text-slate-700">
            <span className="transition-colors group-hover:text-emerald-700">Open</span>
...
function NavItem({
  ...
  return (
    ...
    >
      <Icon size={16} className={active ? "text-emerald-700" : "text-slate-600"} />
      <span>{label}</span>
    </Link>
  );
}
              ...
              <Card className="bg-gradient-to-r from-emerald-50 to-emerald-100">
                <div className="flex items-center gap-4 p-5">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-900">{data.currentBlock.title}</p>
                    <p className="text-xs text-slate-600">{data.currentBlock.time}</p>
                  </div>
                </div>
              </Card>
              ...
              <Card className="bg-gradient-to-r from-emerald-50 to-emerald-100">
                <div className="flex items-center gap-4 p-5">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-900">{data.streakDays} days</p>
                  </div>
                </div>
              </Card>
            </div>
